...
class CompleteMfaSignInUseCase
    implements UseCase<UserEntity, CompleteMfaSignInParams> {
  final IAuthRepository _repository;

  CompleteMfaSignInUseCase(this._repository);

  @override
  Future<Either<OperationState, UserEntity>> call(
    CompleteMfaSignInParams params,
  ) async {
    try {
